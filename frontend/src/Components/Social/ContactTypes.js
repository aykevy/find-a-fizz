...
<div className="brewery--social--list">
    ...
    <a href={`https://www.twitter.com/intent/tweet?text={Going out to ${props.name} in ${props.location},who wants to meet up? #find-a-fizz}`} target="_blank" rel="noopener noreferrer">
